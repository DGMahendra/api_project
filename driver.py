...
def main():
    connection = psycopg2.connect(database="api_database", user="postgres", password="Password@186", host="localhost", port="5432")
    cursor = connection.cursor()

    # Create an instance of APIFetch with the connection and cursor
    ...
    # Fetch university data for each country
    universities_data = {}
    ...
    # Fetch person data
    persons_data = loader.fetch_data("https://randomuser.me/api/")
